	...
	if ($__vars['xf']['tosUrl'] OR $__vars['xf']['privacyPolicyUrl']) {
		...
		if ($__vars['xf']['tosUrl'] AND $__vars['xf']['privacyPolicyUrl']) {
			$__compilerTemp1[] = array(
				'name' => 'accept',
				'required' => 'decline',
				'label' => 'I agree to the <a href="{tos}" target="_blank">terms</a> and <a href="{privacy}" target="_blank">privacy policy</a>.',
				'_type' => 'option',
			);
			...
			$__compilerTemp1[] = array(
				'name' => 'accept',
				'required' => 'decline',
				'label' => 'I agree to the <a href="{tos}" target="_blank">terms and rules</a>.',
				'_type' => 'option',
			);
		} else {
			$__compilerTemp1[] = array(
