<?php
// FROM HASH: 99213385e1f0c29db4ae0bee62f610ad
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__templater->method($__vars['navigation'], 'isInsert', array())) {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Добавить навигацию');
		$__finalCompiled .= '
';
	} else {
		$__finalCompiled .= '
	';
		$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Редактировать элемент навигации' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->escape($__vars['navigation']['title']));
		$__finalCompiled .= '
';
	}
	$__finalCompiled .= '
...
';
	...
	<div class="block-container">
		...
		'label' => 'ID элемента навигации панели управления',
	)) . '
			' . $__templater->formTextBoxRow(array(
		'name' => 'title',
		...
		'explain' => 'По желанию Вы можете указать название иконки Font Awesome',
	)) . '
		...
		'label' => 'Родительский элемент навигации',
	)) . '
		...
		'label' => 'Отображать этот элемент навигации только в режиме отладки' . '
				',
		'_type' => 'option',
	),
	array(
		...
		'selected' => $__vars['navigation']['debug_only'],
		'label' => 'Отображать этот элемент навигации только в режиме разработки' . '
				',
		'_type' => 'option',
	),
	array(
		...
		'label' => 'Скрывать этот элемент навигации когда у него нет видимых дочерних элементов' . '
				',
		'_type' => 'option',
	)), array(
	)) . '
