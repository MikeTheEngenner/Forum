<?php
// FROM HASH: 9352d768a29954465c10cd91192077c5
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Браузер вложений');
	$__finalCompiled .= '

';
	$__compilerTemp1 = array(array(
		'label' => $__vars['xf']['language']['parenthesis_open'] . 'Все типы контента' . $__vars['xf']['language']['parenthesis_close'],
		'_type' => 'option',
	));
	...
	if (!$__templater->test($__vars['attachments'], 'empty', array())) {
					...
					'html' => '
								...
								<div class="dataList-subRow">
									<ul class="listInline listInline--bullet">
										...
										<li>' . ($__templater->escape($__vars['attachment']['Data']['User']['username']) ?: 'Неизвестный пользователь') . '</li>
		...
		$__compilerTemp4 .= '
			<div class="block-body block-row">' . 'Результатов не найдено.' . '</div>
		';
	}
