...
';
	...
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		...
		'label' => 'Автор темы состоит в группах',
		'explain' => 'Соответствие критерию, если автор темы входит в одну или несколько выбранных групп.',
	)) . '
...
';
	...
	$__finalCompiled .= $__templater->formCheckBoxRow(array(
		...
		'label' => 'Автор темы НЕ состоит в группах',
		'explain' => 'Соответствие критерию, если автор темы не входит ни в одну из выбранных групп.',
	)) . '
...
', array(
		'rowtype' => 'input',
		'label' => 'Создано за последние',
		'explain' => 'Используйте 0, если ограничений нет.',
	)) . '
...
', array(
		'rowtype' => 'input',
		'label' => 'Последнее сообщение между',
	)) . '
...
', array(
		'rowtype' => 'input',
		'label' => 'Последнее сообщение за последние',
		'explain' => 'Используйте 0, если ограничений нет.',
	)) . '
...
', array(
		'rowtype' => 'input',
		'label' => 'Количество ответов между',
...
', array(
		'rowtype' => 'input',
		'label' => 'Результат голосования между',
	)) . '
...
', array(
		'rowtype' => 'input',
		'label' => 'Количество реакций на первое сообщение между',
	)) . '
...
', array(
		'rowtype' => 'input',
		'label' => 'Количество просмотров между',
		'explain' => 'Используйте -1, чтобы было без ограничений.',
	)) . '
