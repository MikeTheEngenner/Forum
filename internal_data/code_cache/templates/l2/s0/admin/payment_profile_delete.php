...
';
	...
	<div class="block">
		...
		$__finalCompiled .= $__templater->formInfoRow('
					' . 'Этот платёжный профиль нельзя удалить, поскольку он используется следующими покупателями' . $__vars['xf']['language']['label_separator'] . '
		...
		<div class="block-container">
			<div class="block-body">
				' . $__templater->formInfoRow('
					<div class="blockMessage blockMessage--important blockMessage--iconic">' . 'Примечание: удаление платёжных профилей не повлияет на сделанные покупки (или подписки), которые были сделаны с их использованием.' . '</div>
