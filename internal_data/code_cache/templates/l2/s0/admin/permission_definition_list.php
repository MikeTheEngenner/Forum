	...
	<div class="block">
		<div class="block-container">
			<h2 class="block-header">
				...
				<a href="' . $__templater->func('link', array('permission-definitions/interface-groups/edit', $__vars['interfaceGroup'], ), true) . '" class="u-pullRight">' . 'Изменить' . '</a>
			...
			if (!$__templater->test($__vars['permissionsGrouped'][$__vars['interfaceGroupId']], 'empty', array())) {
				...
				$__finalCompiled .= '
					<div class="block-row">
						' . 'В этой интерфейсной группе пока не создано права. <a href="' . $__templater->func('link', array('permission-definitions/permissions/add', null, array('interface_group_id' => $__vars['interfaceGroupId'], ), ), true) . '">Создать</a>.' . '
					</div>
				';
			}
			$__finalCompiled .= '
