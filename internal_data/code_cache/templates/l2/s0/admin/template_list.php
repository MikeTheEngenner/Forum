		...
		';
			...
			if ($__vars['template']['style_id'] == $__vars['style']['style_id']) {
				$__compilerTemp1[] = array(
					...
					'tooltip' => ($__vars['template']['style_id'] ? 'Вернуть' : 'Удалить') . ' ',
					'_type' => 'delete',
					'html' => '',
				);
			}
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	<div class="block-filterBar">
		<div class="filterBar">
			<a class="filterBar-menuTrigger" data-xf-click="menu" role="button" tabindex="0" aria-expanded="false" aria-haspopup="true">' . 'Уточнить' . '</a>
			<div class="menu menu--wide" data-menu="menu" aria-hidden="true"
				...
				<div class="menu-content">
					<h4 class="menu-header">' . 'Уточнить' . '</h4>
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped($__templater->escape($__vars['style']['title']) . ' - ' . 'Шаблоны');
	$__finalCompiled .= '
