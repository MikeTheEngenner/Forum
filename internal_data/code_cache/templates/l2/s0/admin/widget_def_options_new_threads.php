...
' . $__templater->formSelectRow(array(
	...
	array(
		...
		'explain' => 'Это можно использовать на высоконагруженных форумах для повышения производительности, отображая, по умолчанию, только недавно опубликованные темы.',
	));
