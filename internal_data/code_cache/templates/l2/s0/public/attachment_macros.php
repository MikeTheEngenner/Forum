<?php
// FROM HASH: aa349760fa6a6b6fe37ab9bff86f6174
return array(
	...
	$__finalCompiled .= '
		...
		<div class="file-content">
			<div class="file-info">
				...
				<div class="file-meta">
					' . $__templater->filter($__vars['attachment']['file_size'], array(array('file_size', array()),), true) . ' &middot; ' . 'Просмотры' . $__vars['xf']['language']['label_separator'] . ' ' . $__templater->filter($__vars['attachment']['view_count'], array(array('number', array()),), true) . '
				</div>
			</div>
		</div>
	</li>
