<?php
// FROM HASH: 5a2edcb141dcd0fe6530ab535542d7f9
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
		...
		<div class="attachmentUploads-banner js-attachmentInsertMultiRow u-hidden">
			' . $__templater->button('
				' . 'Вставить несколько' . $__vars['xf']['language']['ellipsis'] . '
			', array(
		'class' => 'button--link js-attachmentSelect',
		'data-toggle' => 'Отменить',
	), '', array(
	)) . '
		...
		'_type' => 'option',
				...
				<li class="js-attachmentSelectInsertActions">
					<span class="insert-label">' . 'Вставить' . $__vars['xf']['language']['label_separator'] . '</span>
			...
			$__finalCompiled .= '
					<div class="file-insert js-attachmentInsert">
						<a class="file-insertLink"
							...
							role="button"
							tabindex="0">
							' . 'Вставить' . $__vars['xf']['language']['ellipsis'] . '
						</a>
						<div class="file-menuOptions">
							<a class="js-attachmentAction" data-action="thumbnail" role="button" tabindex="0"
								data-xf-click="toggle" data-target="< .js-attachmentInsert">' . 'Миниатюра' . '</a>
							<a class="js-attachmentAction" data-action="full" role="button" tabindex="0"
								data-xf-click="toggle" data-target="< .js-attachmentInsert">' . 'Полное изображение' . '</a>
						</div>
					</div>
				';
		} else if ($__vars['attachment']['is_video']) {
			...
			<div class="file-content">
				...
				' . $__templater->func('mustache', array('#thumbnail_url', '
					<div class="file-insert js-insertToggle">
						...
						<div class="file-menuOptions">
							<a class="js-attachmentAction" data-action="thumbnail" role="button" tabindex="0">' . 'Миниатюра' . '</a>
							<a class="js-attachmentAction" data-action="full" role="button" tabindex="0">' . 'Полное изображение' . '</a>
						</div>
					</div>
				')) . '
				' . $__templater->func('mustache', array('^thumbnail_url', '
