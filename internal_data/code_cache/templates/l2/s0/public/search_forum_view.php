<?php
// FROM HASH: a2029d958844de7873b03c7bb52893e7
return array(
...
';
	...
	<link
		...
		title="' . $__templater->filter('RSS лента для ' . $__vars['searchForum']['title'] . '', array(array('for_attr', array()),), true) . '"
	...
	if (!$__templater->test($__vars['threads'], 'empty', array())) {
		...
		$__finalCompiled .= '
					<div class="structItem">
						<div class="structItem-cell">' . 'Нет тем, соответствующих этому разделу поиска.' . '</div>
					</div>
				';
	}
	$__finalCompiled .= '
