...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['xf']['visitor']['user_id']) {
		$__finalCompiled .= '
                ...
                <a class="blockLink rippleButton" href="' . $__templater->func('link', array('whats-new/news-feed', ), true) . '">' . 'Лента новостей' . '</a>
                <a class="blockLink rippleButton" href="' . $__templater->func('link', array('logout', null, array('t' => $__templater->func('csrf_token', array(), false), ), ), true) . '">' . 'Выйти' . '</a>
            ';
	} else {
		$__finalCompiled .= '
                <a class="blockLink rippleButton" href="' . $__templater->func('link', array('login', ), true) . '">' . 'Вход' . '</a>
            ';
	}
	$__finalCompiled .= '
        </div>
