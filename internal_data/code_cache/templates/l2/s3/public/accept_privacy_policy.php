<?php
// FROM HASH: d891f97efac49778ec7d738996c276f0
return array(
...
' . $__templater->form('
	<div class="block-container">
		...
		'name' => 'accept',
		'required' => 'required',
		'label' => 'Я прочитал(а) и принимаю вашу <a href="' . $__templater->escape($__vars['xf']['privacyPolicyUrl']) . '" target="_blank">политику конфиденциальности</a>.',
		'_type' => 'option',
	)), array(
		'label' => '',
	)) . '
