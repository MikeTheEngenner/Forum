<?php
// FROM HASH: 61f89483a6750f953d73d71a855dd69f
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__finalCompiled .= '
			...
			<div class="contentRow-suffix">
				<dl class="pairs pairs--rows pairs--rows--centered">
					<dt>' . 'Темы' . '</dt>
					<dd>' . (($__vars['node']['node_type_id'] == 'Forum') ? $__templater->filter($__vars['extras']['discussion_count'], array(array('number_short', array()),), true) : 'Н/Д') . '</dd>
				</dl>
			</div>
		</div>
	</div>
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Создать тему в...');
	$__finalCompiled .= '
