...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Обзор выбранных сообщений');
	$__finalCompiled .= '

	<div class="block">
		<div class="block-container">
			<div class="block-row block-row--minor">
				' . 'Перетащите значок, чтобы изменить порядок сообщений.' . '
			</div>
									...
									<div class="message message--simple message--bordered message--multiQuoteList message--forceColumns">
										<div class="message-inner">
											<div class="message-cell message-cell--closer message-cell--action">
												<div class="nestable-handle" aria-label="' . $__templater->filter('Перетаскивание', array(array('for_attr', array()),), true) . '">
...
'arguments' => function($__templater, array $__vars) { return array(
		...
		'messageSelector' => '!',
		'storageKey' => '!',
		'addMessage' => 'Сообщение добавлено к мультицитированию',
		'removeMessage' => 'Сообщение удалено из мультицитирования.',
		'row' => false,
	); },
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	$__vars['button'] = $__templater->preEscaped('
		' . $__templater->button('
			' . 'Вставить цитаты' . $__vars['xf']['language']['ellipsis'] . '
		', array(
		...
		'data-add-message' => 'Сообщение добавлено к мультицитированию',
		'data-remove-message' => 'Сообщение удалено из мультицитирования.',
		'icon' => 'quote',
	), '', array(
	)) . '
	');
