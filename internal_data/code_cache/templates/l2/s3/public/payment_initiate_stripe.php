<?php
// FROM HASH: dd1f9d47a0121cc2c6dbe1d4ddb6e4a7
return array(
...
';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('Данные платежа');
	$__finalCompiled .= '
	...
	if ($__vars['paymentProfile']['options']['payment_request_api_enable']) {
		$__compilerTemp1 .= '
				' . $__templater->formRow('
					...
					<div class="formRow-explain">' . 'Нажмите кнопку выше, чтобы оплатить быстрее, используя сохранённые платёжные данные.' . ' ' . 'Платежи безопасно обрабатываются сервисом <a href="' . 'https://stripe.com/' . '" target="_blank">' . 'Stripe' . '</a>. Мы не обрабатываем и не храним Ваши платёжные данные.' . '</div>
				', array(
			'label' => 'Оплатить быстрее',
	...
	<div class="block-container">
		...
		'rowclass' => 'u-hidden',
			...
			' . $__templater->formRow('
				...
				<div class="formRow-explain">' . 'Платежи безопасно обрабатываются сервисом <a href="' . 'https://stripe.com/' . '" target="_blank">' . 'Stripe' . '</a>. Мы не обрабатываем и не храним Ваши платёжные данные.' . '</div>
			', array(
