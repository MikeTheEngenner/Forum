<?php
// FROM HASH: e398f1468c36fcecd4e5944c8b112b03
return array(
...
Прежде чем Ваш контент будет опубликован, пожалуйста, уделите несколько минут для регистрации аккаунта.' . '<br />
		<br />
		' . 'Уже есть аккаунт?' . '
